    ...
    <div style={{ maxWidth: '100%', margin: 'auto', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{height: "100vh", textAlign: "center", margin: "auto"}} >
        ...
        <>
          ...
          <>
            <QContainer>
              <h3 style={{ margin: 0, padding: 0 }}>У вас есть опыт работы на пик-ап траке?</h3>
          ...
          <>
            <QContainer>
              ...
              <p style={{ marginTop: 0, padding: 0, color: 'var(--main-secondary-color)' }}>Пожалуйста введите время в ХХ/ХХ/ХХ формате.</p>
              <Input value={startDate} onChange={(e) => setStartDate(e.target.value)} def placeholder="Пр. ХХ/ХХ/ХХ " />
            </QContainer>
            <Divider style={{ marginTop: '30px' }} />
          </>
          <>
